...
<h3> Escenas </h3>
<ul>
<li> Menu principal: permitira comenzar el juego, comprobar los controles, ver los creditos de los creadores, silenciar el sonido o hacer la pantalla completa.</li>


<li> Menu de pausa: se accederá desde la escena del bosque, castillo o casa de la bruja al hacer click en el boton de pausa que estara en la esquina superior derecha de la pantalla. Mostrara las flores recogidas y el nivel de las habilidades mejoradas hasta el momento. Ademas dara la opcion de silenciar la musica, reanudar el juego, mostrar los controles o volver al menu principal. </li>


<li> Casa de la bruja: será el sitio donde empiece el juego, el jugador podra volver aqui en cualquier momento donde podra descansar para recuperar su vida al completo. No habra enemigos, sera un sitio de descanso.  spawnear dentro? fuera ? forzar a que bruja tenga un camino directo y descubra el pueblo destruido? Podra volver en cualquier momento a su casa para descansar y recuperar vida? </li>


<li> Bosque: sera el mapa mas grande donde tendrá lugar la mayoria del juego. Tendra caminos que no estaran claramente marcados, es decir, en base al entorno se intentara que el jugador siga un camino, aunque es libre de salirse de el. Contara con sitios especificos donde el fondo variara de un bosque con arboles donde podra encontrar las distintas flores. Asimismo, depende de en que zona apareceran distintos enemigos</li>


<li> Castillo: sera una escena nueva, no se encontrará enemigos? se enfrentara directamente al final boss </li>
<li> Mensaje de Muerte:  escena nueva con mensaje → por ejemplo lema de la inquisicion? “Alzate oh dios a defender tu causa”</li>

</ul>
<h3> Habilidades </h3>
A medida que la bruja recoja la experiencia que suelten los enemigos al morir, su nivel de experiencia aumentara. Cada vez que alcance un nuevo nivel aparecerán en pantalla 3 posibles opciones de habilidades a mejorar donde el jugador podra elegir solo una. Cuantas mejoras se pueden hacer por habilidad, 4 o 5? Las posibles habilidades son: <br>
<ul>
<li> Velocidad de ataque: permitira que los ataques de la bruja se lancen mas a menudo.</li>
<li> Velocidad de movimiento: permitira que la bruja se mueva mas rapido por el mapa. </li>
<li> Escudo: permitira que los daños que le produzcan los enemigos sea menor. </li>
<li> Vida: </li>
<li> Daño: </li>
<li> Regeneracion de vida: </li>
</ul>


<h3> Flores</h3>
Las flores se encontraran en distintos lugares del mapa del bosque. Habra 4 en total, una vez la bruja las recoja se desbloqueara un nuevo ataque para la bruja pero tambien aumentara la dificultad del juego. Las flores son:
se mostrarán en el menu de pausa? son 4: amapola, diente de leon, mandragora y musgo? poderes que dan cada una: fuego, rayos, explosiones y agua? Las recogera a medida que pasea por el mapa, es decir, seguira enfrentandose a las hordas no habra pausas de enemigos por estar cerca de flores.
<ul>
<li> Amapola: <br>
          
<li> Diente de león: </li>
<li> Mandragora: </li>
<li> Mierda de bruja: </li>
                      
<h3> Ataques </h3>
La bruja atacara a los enemigos automaticamente, el jugador solo controlara el movimiento de la bruja. Desde un principio la bruja tendra un “Ataque Basico” en el que lanzara proyectiles que seguiran a un enemigo hasta alcanzarlo, que hara un daño de: x. A medida que recoja las flores podra desbloquear nuevos ataques como:
<ul>
<li> Bola de fuego: al recoger la amapola </li>
<li> Rayos: </li>
<li> Ataque de agua?: </li>
<li> Ataque de mandragora?: </li>
</ul>
<h3>Experiencia</h3>
Se ira acumulando en una barra azul siempre presente en la pantalla de juego. Ira aumentando segun la bruja recoja las bolas de experiencia proporcionadas al morir los enemigos. Existira un nivel maximo de experiencia que sera 50?  no seguira subiendo, de esta forma sabra que deberia dirigirse al boss. Como alternativa sí que podria seguir subiendo pero que vaya curandose un porcentaje, como en el vampire survivors.
<h3> Vida </h3>
Se vera representada como una barra verde siempre presente en la pantalla de juego. Disminuye con cada ataque de los enemigos, pero a su vez se regenera de forma automatica cada x segundos de juego una cantidad y hasta alcanzar un maximo z.
<h3> Enemigos </h3>
Tendremos una clase padre Enemy? que metodos tendran en comun?. Cada tipo de enemigo spawneara en distintos puntos del mapa. Apareceran grupos de enemigos y, el numero de enemigos aumentara y tambien la dificultad (mayor daño mayor aguante) segun avance el juego, en base a las flores recogidas y el nivel de experiencia obtenido. Tipos de enemigos:
<ul>
<li> Lobos: apareceran en el bosque, tendran un daño de: y una vida total de: </li>
<li> Caballeros de inquisicion: </li>
<li> Arqueros de inquisicion: </li>
<li> Final Boss: sera inspirado en el gran insquisidor Torquemada, tendra aspecto humano hasta que llegue a la mitad de vida en la que obtendra un aspecto demoniaco?, siempre sera mucho mas grande que la protagonista. </li>
</ul>
